...
<CardGroup cols={2}>
  <Card title="Gesture animations" icon="hand">
    Respond to drag, swipe, and pan gestures
  </Card>
  <Card title="Spring physics" icon="leaf">
    Create natural motion with physics-based animations
  </Card>
  <Card title="Path animations" icon="route">
    Animate along SVG paths
  </Card>
  <Card title="Custom easings" icon="wave-square">
    Build custom easing curves for unique effects
  </Card>
</CardGroup>
